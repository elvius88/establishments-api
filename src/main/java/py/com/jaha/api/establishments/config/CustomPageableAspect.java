...
import static py.com.jaha.api.establishments.constants.GlobalConstants.PARAM_PAGE_KEY_NAME;
import static py.com.jaha.api.establishments.constants.GlobalConstants.PARAM_PAGE_SIZE_NAME;
...
import py.com.jaha.api.establishments.commons.CustomPagination;

@Aspect
@Component
public class CustomPageableAspect {

  @Around("@annotation(py.com.jaha.api.establishments.config.CustomPageable) && execution(py.com.jaha.api.establishments.commons.ApiPageableResponse+ *(..)) && args(page, ..)")
